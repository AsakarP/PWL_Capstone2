            ...
            <div class="container-fluid">
                <div class="card p-4">
                    <div class="card-body">
                        ...
                        <form method="Post" action="{{ route('mah-update', ['id' => $ma->id]) }}">
                            @csrf
                            @method('patch')
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Contoh: 3.75" name="ipk"
                                    value="{{ $ma->ipk }}" required maxlength="4">
                            </div>
                            <div class="form-group">
                                <label>Poin Portofolio</label>
                                <input type="text" class="form-control" placeholder="Contoh: 385" name="poin"
                                    value="{{ $ma->poin }}" required maxlength="4">
                            </div>
